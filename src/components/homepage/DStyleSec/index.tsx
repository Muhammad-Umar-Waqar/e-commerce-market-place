  ...
  return (
    <div className="px-4 xl:px-0">
      <section className="max-w-frame mx-auto bg-[#F0F0F0] px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        ...
        <div className="flex flex-col sm:flex-row  space-y-4 sm:space-y-0 md:h-[289px] sm:space-x-5 mb-4 sm:mb-5">
          <DressStyleCard
            title="Casual"
            url="/shop#casual"
            className="md:max-w-[260px] xl:max-w-[407px]  h-[190px]  lg:max-w-[360px] bg-[url('/images/dress-style-1.png')]"
          />
          <DressStyleCard
            title="Formal"
            url="/shop#formal"
